...
model = torch.load('results/vgg16_bn_compression_4.0_cifar10_l1.pth').cuda()
...
model_trt = torch2trt(model,[example_input], fp16_mode=True, int8_calib_dataset=calib_dataset, max_batch_size=128)
...
torch.save(model_trt.state_dict(), path+f"int8{model_name}_c10_test.pth")